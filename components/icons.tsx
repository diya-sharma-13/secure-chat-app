...
export const PersonIcon: React.FC<IconProps> = ({ className = "", size = 16 }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className}>
...
export const SendIcon: React.FC<IconProps> = ({ className = "", size = 16 }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className}>
    <path d="M15.854.146a.5.5 0 0 1 .11.54L13.026 8.5l2.938 7.814a.5.5 0 0 1-.11.54.5.5 0 0 1-.54.11L1.5 12.5l13.814-12.354a.5.5 0 0 1 .54-.11ZM2.5 11.5l11.5-10L3 8.5l-.5 3Z" />
  </svg>
)

export const PeopleIcon: React.FC<IconProps> = ({ className = "", size = 16 }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className}>
...
export const ExclamationIcon: React.FC<IconProps> = ({ className = "", size = 16 }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className}>
